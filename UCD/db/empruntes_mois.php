<?php 
    ...
    class myPDF extends FPDF{
        function header(){
            ...
            $this-> Ln(30);
            $sql = "select Count(*) as nbr from pret 
            ...
            $this->Cell(250,0,'Les empruntes de mois (Order by Date d\'emprunt ) est : '.$nbrp.' Livres',0,0,'C');
            $this->Ln(10);
        ...
        function ViewTable($db){
            ...
            where p.codexp = e.codexp && l.codliv = e.codliv AND  MONTH(p.dateaccord) = MONTH(NOW())AND YEAR(p.dateaccord) = YEAR(NOW())                                
