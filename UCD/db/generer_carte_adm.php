...
function Code128($x, $y, $code, $w, $h) {
    ...
    for ($i=0; $i<strlen($crypt); $i++) {                                      // BOUCLE D'IMPRESSION
        ...
        function header(){
            ...
            if (isset($_GET['adm'])) {
                $adm = $_GET['adm'];
                $sql ="SELECT * from administrateur where codbar like '$adm'";
            ...
            $this->Cell(150,0,'CIN ADMIN',0,0,'L');
            $this->SetFont('Times','B',11);
            $this->Cell(-220,0,$cin,0,0,'C');
            $this->Ln(5);
            $this->SetFont('Times','U',9);
            $this->Cell(150,0,'NOM ADMIN',0,0,'L');
            $this->SetFont('Times','B',11);
            $this->Cell(-220,0,$nom,0,0,'C');
            $this->Ln(5);
            $this->SetFont('Times','U',9);
            $this->Cell(150,0,'PRENOM ADMIN',0,0,'L');
            $this->SetFont('Times','B',11);
            $this->Cell(-220,0,$pre,0,0,'C');
            $this->Ln(15);
