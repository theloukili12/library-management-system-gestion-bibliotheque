...
function Code128($x, $y, $code, $w, $h) {
    ...
    for ($i=0; $i<strlen($crypt); $i++) {                                      // BOUCLE D'IMPRESSION
        ...
        function header(){
            $this->Image('..\img\UCD_LOGO.jpg',15,12,20,20);
            $this->SetFont('Arial','B',14);
            $this->Cell(450,5,'',0,0,'C');
            $this-> Ln();
            $this->SetFont('Arial','B',14);
            $this->Cell(180,5,'Universite Chouaib Doukkali',0,0,'C');
            $this-> Ln(5);
            $this->SetFont('Arial','',10);
            $this->Cell(180,5,'Avenue Jabran Khalil Jabrani',0,0,'C');
            $this-> Ln();
            $this->Cell(180,5,'B.P 299-24000',0,0,'C');
            $this-> Ln();
            $this->Cell(180,5,'El jadida Grand-Casablanca Maroc',0,0,'C');
            $this-> Ln(10);
            ...
            if (isset($_GET['etd'])) {
                $cne = $_GET['etd'];
                $sql ="
                SELECT etudiant.*,filiere.intitulefil
                                FROM etudiant ,filiere 
                                WHERE etudiant.codfil = filiere.Codfil and codbar='$cne' ";
            ...
            $this->Cell(150,0,'CNE ETUDIANT',0,0,'L');
            $this->SetFont('Times','U',14);
            $this->Cell(-195,0,$cne,0,0,'C');
            $this->Ln(7);
            $this->SetFont('Times','U',9);
            $this->Cell(150,0,'NOM ETUDIANT',0,0,'L');
            $this->SetFont('Times','U',14);
            $this->Cell(-195,0,$nom.' '.$pre,0,0,'C');
            $this->Ln(7);
            $this->SetFont('Times','U',9);
            $this->Cell(150,0,'FILIERE ETUDIANT',0,0,'L');
            $this->SetFont('Times','U',11);
            $this->Cell(-190,0,$fil,0,0,'C');
            $this->Ln(25);
        }
    }
        ...
        $pdf = new myPDF();
        $pdf->AliasNbPages();
        $pdf->AddPage('L',array(80,135),0);
       //A set
        $adm = $_GET['etd'];
        $pdf->Code128(50,58,$adm,80,20);
        $pdf->SetXY(50,45);
