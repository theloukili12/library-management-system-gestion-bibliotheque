    ...
    <div class="main-content">
        ...
        <section class="recent">
                ...
                <div class="activity-grid">
                    <h2 class="dash-title" >Livre empruntee ce mois</h2>
...
$sql = "
Select l.titreliv ,p.cinadm , etd.cne_etd ,p.dateretour, p.dateaccord 
from pret p , exemplaire e , livre l ,etudiant etd 
where p.codexp = e.codexp && l.codliv = e.codliv AND  MONTH(p.dateaccord) = MONTH(NOW())AND YEAR(p.dateaccord) = YEAR(NOW()) AND p.cne_etd = etd.cne_etd    ";
        ...
        <?php }} ?>
                    ...
                    <div class="summary" >
                         <div class="summary-card" style="background: none;">
                                ...
                                <a href="../db/empruntes_mois.php" target="_blank">Imprimmer les donneés</a>
                                </button>
                        </div>
                    </div>
                    </div>
